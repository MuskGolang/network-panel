...
const CONFIG_ITEMS: ConfigItem[] = [
  ...
  },
  {
    ...
    label: "开启用户注册",
    description:
      "开启后，登录页显示“注册”入口，注册用户可使用面板功能（按其配额限制）",
    type: "switch",
  },
  {
    ...
    description:
      "控制后端在等待节点执行安装脚本的最长时间，同时传递给 Agent 的 timeoutSec，避免误判超时导致重复安装",
    type: "input",
  },
  {
    ...
    description:
      "控制 iperf3 诊断中入口本地临时端口连通性探测(127.0.0.1)的超时时长，默认为 3 秒。调大可降低偶发抖动导致的误判",
    type: "input",
  },
  {
    key: "show_probe",
  ...
  },
  {
    ...
    description:
      "默认关闭，开启后显示“网络”菜单并在节点卡片上显示网络延迟/探针信息",
    type: "switch",
  },
  {
  ...
  return (
    <div className="np-page max-w-5xl mx-auto">
      ...
      <div className="np-page-header">
        ...
        <div>
          <h1 className="np-page-title">网站配置</h1>
      ...
      <Card className="np-card">
        <CardHeader className="pb-4">
          <div className="np-card-header w-full">
            <div>
      ...
      {/* 操作提示 */}
      {hasChanges && (
        <Card className="np-card bg-warning-50 dark:bg-warning-900/20 border-warning-200 dark:border-warning-800">
